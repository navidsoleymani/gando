...
class AsyncoRequestManager:
    ...
    def __remove_from_incomplete_requests_temporary(
        self, item: RequestSchema):
    ...
    def add_to_requests(
        self, url, method=None, data=None, headers=None, cookies=None,
        schema=None):
    ...
    def __add_to_responses(self, request: RequestSchema, _response):
        ...
        data = request.sch(
            **_response.json()) if request.sch else _response.json()
    ...
    def export(self):
        ...
        _sort_response.items = sorted(self.__responses.items,
